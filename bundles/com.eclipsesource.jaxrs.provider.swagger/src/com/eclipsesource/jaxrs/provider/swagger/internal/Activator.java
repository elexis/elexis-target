...
public class Activator implements BundleActivator {
  ...
  public void start( BundleContext bundleContext ) throws Exception {
    ...
    SwaggerScannerLocator.getInstance()
      .putScanner( SwaggerContextService.SCANNER_ID_DEFAULT,
                   new OSGiJaxRsScanner( swaggerConfiguration ) );
    ScannerFactory.setScanner( new OSGiJaxRsScanner( swaggerConfiguration ) );
    registrations.add( bundleContext
      .registerService( ApiListingResource.class.getName(), new ApiListingResource(), null ) );
    registrations.add( bundleContext
      .registerService( SwaggerSerializers.class.getName(), new SwaggerSerializers(), null ) );
  }
  ...
  private SwaggerConfiguration registerSwaggerConfiguration( BundleContext bundleContext ) {
    ...
    registrations.add( bundleContext
      .registerService( ManagedService.class.getName(), swaggerConfiguration, properties ) );
